...
const staticRoutes: Array<{
  ...
  { path: '/topic', changeFrequency: 'weekly', priority: 0.75 },
  { path: '/about', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/contact', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/faq', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/login', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/search', changeFrequency: 'weekly', priority: 0.55 },
  { path: '/tos', changeFrequency: 'yearly', priority: 0.35 },
  { path: '/privacy-policy', changeFrequency: 'yearly', priority: 0.4 },
  { path: '/privacy-and-policy', changeFrequency: 'yearly', priority: 0.35 },
