...
async function BlogListSection() {
  ...
  const hasInitialBlogs = Array.isArray(initialBlogs) && initialBlogs.length > 0;
  return <BlogListClient initialBlogs={initialBlogs} initialBlogsLoaded={hasInitialBlogs} />;
}
