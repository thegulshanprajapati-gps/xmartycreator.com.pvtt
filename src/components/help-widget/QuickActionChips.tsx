      ...
      <div className="flex gap-2 overflow-x-auto chat-scrollbar">
        {actions.map((action) => (
          <button
            ...
            className="group inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border border-cyan-300/30 bg-[hsl(var(--vasant-chip)/0.75)] px-3 py-1.5 text-[11px] font-semibold text-slate-700 shadow-[0_10px_24px_-20px_rgba(6,182,212,0.55)] transition-all duration-200 ease-out hover:border-cyan-300/70 hover:bg-[hsl(var(--vasant-chip)/0.95)] hover:text-teal-700 dark:border-cyan-200/25 dark:bg-[hsl(var(--vasant-chip)/0.58)] dark:text-cyan-100 dark:hover:text-cyan-50"
          >
